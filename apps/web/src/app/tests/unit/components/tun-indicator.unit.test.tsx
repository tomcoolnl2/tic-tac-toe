...
describe('TurnIndicator component', () => {
    ...
    it('should render the component correctly', () => {
        const { container } = render(<TurnIndicator currentPlayer={PlayerSymbol.X} playerSymbol={PlayerSymbol.X} />);
    ...
    it('should render the components text correctly as Player O', () => {
        const { container } = render(<TurnIndicator currentPlayer={PlayerSymbol.X} playerSymbol={PlayerSymbol.O} />);
