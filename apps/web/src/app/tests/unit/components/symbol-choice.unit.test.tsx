...
describe('SymbolChoice component', () => {
    it('should render the component correctly', () => {
        const { container } = render(
            <SymbolChoice playerSymbol={PlayerSymbol.X} handleSymbolChoiceChange={jest.fn()} />
        );
    ...
    it('should call handleSymbolChoiceChange when the checkbox is clicked', () => {
        ...
        const { container } = render(
            <SymbolChoice playerSymbol={PlayerSymbol.X} handleSymbolChoiceChange={handleSymbolChoiceChangeMock} />
        );
        const checkbox = container.querySelector('#choose-player');
    ...
    it('should not check the checkbox when playerSymbol is O', () => {
        const { container } = render(
            <SymbolChoice playerSymbol={PlayerSymbol.O} handleSymbolChoiceChange={jest.fn()} />
        );
        const checkbox = container.querySelector('#choose-player') as HTMLInputElement;
